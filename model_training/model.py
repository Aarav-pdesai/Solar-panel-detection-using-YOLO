...
if __name__ == '__main__':
    ...
    results_test = model.val(split='test', verbose = False) 
    
    metrics = results_test.results_dict  
    #model metrics, mAP50, precision and recall
    ...
    df = pd.read_csv("C:/Users/aarav/OneDrive/Desktop/IIT_GN_TASK/runs/detect/train2/results.csv")  
    ...
    def compute_precision_recall(ground_truth_boxes, predicted_boxes, iou_threshold=0.5):
        ...
        recall = tp_sum / (len(ground_truth_boxes) + 1e-6)
